...
export default class CertGameBilling extends LightningElement {
    ...
    async fetch() {
        ...
        if (!id) {
            this.error = 'No Tenant Id provided. Place this component on a Tenant__c record page or set the Tenant Id property.';
            return;
        }
        this.loading = true;
    ...
    get hasEvents() { return this.data && this.data.events && this.data.events.length > 0; }
