...
export default class CertGamePlayerDashboard extends LightningElement {
    ...
    get resolvedId() {
        return this.recordId || this.playerId || null;
    }
    get hasPlayer() {
        return this.data && this.data.player;
    }
    get hasDomains() {
        return this.data && this.data.domains && this.data.domains.length > 0;
    }
    get hasAnswers() {
        return (
            this.data &&
            this.data.recentAnswers &&
            this.data.recentAnswers.length > 0
        );
    }
    get hasAchievements() {
        return (
    ...
    get hasPlans() {
        return (
            this.data && this.data.studyPlans && this.data.studyPlans.length > 0
        );
    }
    get rankLabel() {
        const p = this.data.player;
        return `Rank ${p.rank} of ${p.rankPool}`;
    }
    get statTiles() {
        const p = this.data.player;
        return [
