...
(() => {
    ...
    var vo = (e, t) => {
        ...
        if (e != null && Bt)
            for (var o of Bt(e))
                t.indexOf(o) < 0 && bo.call(e, o) && (r[o] = e[o]);
        return r;
    };
    var Cr = (e, t) => () => (
    ...
    var go = (e, t, r) =>
        new Promise((o, n) => {
            var i = (c) => {
                ...
                a = (c) =>
                    c.done ? o(c.value) : Promise.resolve(c.value).then(i, s);
  ...
  `)
        ...
        return (
            ...
            (t.prototype._trimBuffer = function () {
                var r = this,
                    ...
                    a = (s ? 1 : 2) * o;
                if (
                    (o < 1 / 0 && a < i.length && i.splice(0, i.length - a), !s)
                ) {
                    for (
                        var c = n.now(), p = 0, l = 1;
                        l < i.length && i[l] <= c;
            ...
            (t.prototype.requestAsyncId = function (r, o, n) {
                return (
                    ...
                    n !== null && n > 0
                        ...
                        : (r.actions.push(this),
                          r._scheduled ||
                              (r._scheduled = Tt.requestAnimationFrame(
                                  function () {
    ...
    var Fo = (function (e) {
        ...
        return (
            (t.prototype.flush = function (r) {
                ...
                r
                    ? (o = r.id)
                    : ((o = this._scheduled), (this._scheduled = void 0));
                var n = this.actions,
                    i;
                r = r || n.shift();
    ...
    function ir(e) {
        return (
            ...
            I(e == null ? void 0 : e[Symbol.asyncIterator])
        );
    }
    function ar(e) {
        ...
        return H(
            () => (
                ...
                L(
                    ...
                    h(t, "error").pipe(
                        b(() =>
                            Nr(() => new ReferenceError(`Invalid script: ${e}`))
                        )
                    )
                ).pipe(
                    m(() => {}),
    ...
    function oo(e, t) {
        let r = t & 2,
            ...
            n = Object.keys(e.terms)
                .filter((c) => !e.terms[c])
                .reduce(
                    (c, p) => [...c, x("del", null, (0, In.default)(p)), " "],
                    []
                )
                .slice(0, -1),
            i = Te(),
        ...
        let { matches: r } = matchMedia("(hover)"),
            o = H(() => {
                ...
                if (f instanceof HTMLElement) {
                    ...
                    if (
                        typeof d != "undefined" &&
                        (f.classList.contains("annotate") ||
                            V("content.code.annotate"))
                    ) {
                        let v = Tr(d, e, t);
                        l.push(
                            Le(f).pipe(
                ...
                if (
                    ...
                    let d = +u[0].id.split("-").pop(),
                        v = $n();
                    (s.push(v),
                        V("content.tooltips") && l.push(Xe(v, { viewport$ })));
                    ...
                    let re = fe(u).pipe(
                        ...
                        k = Zr(y).pipe(
                            g((R) => R.startsWith(`__codelineno-${p}-`))
                        );
                    (k.subscribe((R) => {
                        let [, , se] = R.split("-"),
                        ...
                        for (let Se of he) {
                            ...
                            ((Ue.className = "hll"),
                                Ue.append(
                                    ...Array.from(Se.childNodes).slice(1)
                                ),
                                Se.append(Ue));
                        }
                    }),
                ...
                if (
                    ...
                    let d = Hn(a.id);
                    (s.push(d),
                        V("content.tooltips") && l.push(Xe(d, { viewport$ })));
                }
                if (s.length) {
                    let d = Pn();
    ...
    function Jn(e, t) {
        ...
        if (
            !(V("navigation.instant.preview") || e.hasAttribute("data-preview"))
        )
            return y;
        e.removeAttribute("title");
    ...
    function ss(e) {
        ...
        return L(
            ...e.map((r) =>
                h(r, "change").pipe(m(() => j(`label[for="${r.id}"]`)))
            )
        ).pipe(
            Q(j(`label[for="${t.id}"]`)),
            m((r) => ({ active: r }))
                    ...
                    Vt(i, {
                        content$: new F((s) => {
                            let a = new URL(i.href).hash.slice(1),
                                c = Array.from(
                                    document.getElementById(a).cloneNode(!0)
                                        .children
                                ),
                                p = wr(...c);
                            return (
    ...
    function si(e, { header$: t, main$: r }) {
        return H(() => {
            ...
            o.pipe(ne("active"), Pe(t)).subscribe(
                ([{ active: s }, { hidden: a }]) => {
                    (e.classList.toggle("md-header--shadow", s && !a),
                        (e.hidden = a));
                }
            );
        ...
        return z([o, n, t]).pipe(
            m(
                ([
                    ...
                    (p = Math.max(
                        0,
                        p - Math.max(0, s - c, i) - Math.max(0, p + c - a)
                    )),
            ...
            return (
                i.subscribe((s) => {
                    if (
                        ...
                        ((s.color.scheme = c.getAttribute(
                            "data-md-color-scheme"
                        )),
                            (s.color.primary = c.getAttribute(
                                "data-md-color-primary"
                            )),
                            (s.color.accent = c.getAttribute(
        ...
        return (
            L(
                ...
                history.state !== null || !a.hash
                    ? window.scrollTo(
                          0,
                          (p = (c = history.state) == null ? void 0 : c.y) !=
                              null
                              ? p
                              : 0
                      )
    ...
    function Mi(e, { worker$: t, keyboard$: r }) {
        ...
        return (
            o
                ...
                .subscribe(
                    (a) => (e.innerHTML = a.join("").replace(/\s/g, "&nbsp;"))
                ),
        ...
        try {
            ...
            (h(e, "click")
                .pipe(
                    g(
                        ({ target: c }) =>
                            c instanceof Element && !!c.closest("a")
                    )
                )
                        ...
                        return $(
                            [...o].reduce((p, [l, f]) => {
                                for (
                                    ;
                                    c.length &&
                                    o.get(c[c.length - 1]).tagName >= f.tagName;
                                )
                                    c.pop();
                                let u = f.offsetTop;
        ...
        $s = H(() =>
            L(
                ...
                ...me("header-title").map((e) =>
                    ci(e, { viewport$: ke, header$: ft })
                ),
                ...me("sidebar").map((e) =>
                    e.getAttribute("data-md-type") === "navigation"
                        ? eo(Vi, () =>
                              lo(e, { viewport$: ke, header$: ft, main$: qt })
                          )
                        : eo(Lr, () =>
                              lo(e, { viewport$: ke, header$: ft, main$: qt })
                          )
