...
## Trivia_Question\_\_c — every field
...
## Trivia_Answer_Choice\_\_c — every field
...
## Question_Citation\_\_c — every field
    ...
    "questions": [
        {
            ...
            "glossaryTerms": [
                {
                    "term": "Sharing Rule",
                    "definition": "Automatic record-level access extension to a group of users."
                }
            ],
...
## Player\_\_c — every field (post-cleanup)
...
## Tenant\_\_c — every field (post-cleanup)
...
## Game_Session\_\_c — every field (post-cleanup)
...
## Game_Round\_\_c — every field (post-cleanup)
...
## Player_Answer\_\_c — every field (post-cleanup)
